...
public class OpenData
{
	...
	* @param city The Wikipedia article and OpenWeatherMap city. */
	 ...
	 public static void RetrieveData(String city) throws  IOException
	 {
		 ObjectMapper mapper = new ObjectMapper();
		 OpenWeatherMap weather_obj = mapper.readValue(new URL("http://api.openweathermap.org/data/2.5/weather?q="+city+"&APPID="+City.appid+""), OpenWeatherMap.class);
